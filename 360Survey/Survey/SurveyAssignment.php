...
function GetOpenAssignmnetCountOfSurvey($con, $survey_id){
  echo "-------------------GetOpenAssignmnetCountOfSurvey:[start]------------------------\n";
  try {
  ...
  echo "-------------------GetOpenAssignmnetCountOfSurvey:[end]------------------------\n";
  return 1;
...
function GetOpenAssignmnetCountForEmployeeInSurvey($con, $survey_id, $eid){
  echo "-------------------GetOpenAssignmnetCountForEmployeeInSurvey:[start]------------------------\n";
  try {
  ...
  echo "-------------------GetOpenAssignmnetCountForEmployeeInSurvey:[end]------------------------\n";
  return 1;
}
