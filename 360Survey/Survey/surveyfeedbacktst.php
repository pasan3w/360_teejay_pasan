...
SurveyorEID, 
SurveyorType, 
QuestionCategoryID, = $category_feedback_array[0],
QuestionID = $category_feedback_array[1],
$category_feedback_array[2] = type of the question 0 or 1
Rating = $category_feedback_array[3]
